...
RECYCLE_INSTRUCTIONS_VN = {
    ...
    "cardboard": "Rửa sạch, gấp phẳng và bỏ vào thùng tái chế màu <strong>xanh dương</strong> dành cho giấy & carton. Ở Việt Nam, thùng giấy thường có màu xanh dương hoặc xanh lá.",  # Reuse từ paper
...
ENV_TIPS_VN = {
    ...
    "cardboard": "Tái chế 1 tấn giấy/cartons giúp tiết kiệm khoảng 17 cây trưởng thành và giảm lượng nước thải đáng kể!",  # Reuse từ paper
...
def result_box(label: str, conf: float):
    ...
    # Handle merge cardboard vào paper nếu cần, nhưng vì có separate class, giữ nguyên nhưng reuse instruction
    ...
    vn_label_map = {
        ...
        "cardboard": "Giấy (Paper/Cardboard)",
